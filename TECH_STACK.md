# SmartSeller 智能选品系统 — 技术栈文档（面试版）

> **一句话定位**：面向跨境电商卖家的全链路选品分析平台，覆盖 Amazon/eBay 双平台，集成榜单扫描、关键词搜索、竞品分析、评论 AI 分析、利润计算等核心能力。
>
> **代码规模**：约 **20,000+ 行** Python 后端 + **8,858 行** 前端 SPA，12 个功能模块
